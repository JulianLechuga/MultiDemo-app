...
export default function MainPage() {
  ...
  return (
    <div className="flex-grow bg-[#FAF8F5] text-stone-800 font-sans selection:bg-[#8A4F35] selection:text-white overflow-x-hidden">
      
      {/* 1. NAVEGACIÓN PRINCIPAL (ESTILO EDITORIAL LIMPIO) */}
      <header className="border-b border-stone-200/80 bg-[#FAF8F5]/90 backdrop-blur-md sticky top-0 z-30 w-full">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex flex-col">
              <span className="font-playfair font-black text-lg md:text-xl tracking-tight text-stone-900 leading-none">
          ...
          <nav className="hidden md:flex items-center gap-7 text-xs uppercase tracking-wider font-extrabold text-stone-500">
            <button onClick={() => handleScrollTo("demos")} className="hover:text-stone-900 transition cursor-pointer">Estilos Demo</button>
            <button onClick={() => handleScrollTo("beneficios")} className="hover:text-stone-900 transition cursor-pointer">Qué Incluye</button>
            <button onClick={() => handleScrollTo("ferias")} className="hover:text-stone-900 transition cursor-pointer">Stand QR</button>
            <button onClick={() => handleScrollTo("funcionamiento")} className="hover:text-stone-900 transition cursor-pointer">Proceso</button>
            <button onClick={() => handleScrollTo("precios")} className="hover:text-stone-900 transition cursor-pointer">Planes</button>
          </nav>
      ...
      <section className="relative pt-20 pb-24 md:pt-32 md:pb-36 border-b border-stone-200/60 bg-[radial-gradient(ellipse_60%_60%_at_50%_-10%,rgba(138,79,53,0.06),rgba(255,255,255,0))]">
        {/* Líneas tenues decorativas de diseño editorial */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(44,37,32,0.015)_1px,transparent_1px),linear-gradient(to_bottom,rgba(44,37,32,0.015)_1px,transparent_1px)] bg-[size:5rem_5rem] pointer-events-none"></div>
        
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6 text-left relative z-10">
            <span className="inline-flex items-center gap-1.5 py-1.5 px-4 rounded-full text-xs font-bold bg-[#8A4F35]/5 text-[#8A4F35] border border-[#8A4F35]/15">
              <Sparkles size={12} className="text-[#8A4F35] animate-pulse" />
              Diseño Web a Medida para Emprendedores Universitarios
            </span>
            
            <h1 className="text-4xl md:text-6xl font-playfair font-black text-stone-900 tracking-tight leading-tight">
            ...
            <p className="text-stone-550 text-base md:text-lg leading-relaxed max-w-xl">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              ...
              <button 
                onClick={() => handleScrollTo("contacto")} 
                className="bg-white hover:bg-stone-50 text-stone-700 font-bold py-3.5 px-7 rounded-xl border border-stone-250 transition duration-200 cursor-pointer text-sm md:text-base shadow-sm"
              >
            ...
            <div className="flex flex-wrap items-center gap-5 pt-5 text-xs text-stone-500 border-t border-stone-200/80">
          ...
          <div className="lg:col-span-5 relative flex justify-center">
            ...
            <div className="w-full max-w-sm rounded-[42px] border-[6px] border-stone-900 bg-stone-900 p-2.5 shadow-[0_25px_60px_-15px_rgba(44,37,32,0.15)] relative group transition-transform duration-500 hover:scale-[1.01] animate-float">
              ...
              {/* QR Badge */}
              <div className="absolute -bottom-6 -right-6 bg-white border border-stone-200 text-stone-700 py-3.5 px-4 rounded-2xl flex items-center gap-3 shadow-xl border-l-4 border-l-[#8A4F35]">
                <div className="p-2 bg-[#8A4F35]/5 text-[#8A4F35] rounded-xl border border-[#8A4F35]/10">
                  <QrCode size={20} />
                </div>
                <div>
                  <h4 className="text-xs font-bold text-stone-900 tracking-tight">Catalogo QR Stand</h4>
                  <p className="text-[10px] text-stone-500">Escaneás en feria y pedís</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-26 bg-white border-y border-stone-200/80 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-3.5xl md:text-5xl font-playfair font-black text-stone-900 tracking-tight leading-tight">
              ...
              <div className="space-y-5 pt-2">
                {[
                  ...
                  <div key={i} className="flex gap-4 items-start">
                    <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[#8A4F35]/5 text-[#8A4F35] border border-[#8A4F35]/15 flex items-center justify-center font-bold text-xs font-mono">
                      {item.step}
                    </div>
                    <div>
                      <h4 className="text-stone-900 font-bold text-sm md:text-base">{item.title}</h4>
                      <p className="text-stone-500 text-xs md:text-sm mt-0.5 leading-relaxed">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-[#FAF8F5] p-6 md:p-10 rounded-3xl border border-stone-200/80 shadow-sm relative overflow-hidden flex flex-col justify-center">
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-3">
                {/* Paso 1 */}
                <div className="flex flex-col items-center bg-white border border-stone-200 rounded-2xl p-4 w-full md:w-32 text-center shadow-sm">
                  <div className="w-9 h-9 rounded-full bg-pink-500/5 text-pink-600 flex items-center justify-center mb-2">
                    <Instagram size={18} />
                  </div>
                  <span className="text-xs font-bold text-stone-950">Instagram</span>
                  <span className="text-[9px] text-stone-400 mt-1 leading-tight">El cliente ve tu contenido</span>
                </div>
                
                <div className="text-stone-300 rotate-90 md:rotate-0 font-bold text-lg">➔</div>

                {/* Paso 2 */}
                <div className="flex flex-col items-center bg-white border-2 border-[#8A4F35]/40 rounded-2xl p-4 w-full md:w-36 text-center shadow-md relative">
                  ...
                  <span className="text-xs font-bold text-stone-950">Catálogo Web</span>
                  <span className="text-[9px] text-stone-500 mt-1 leading-tight">Consulta precios y stock</span>
                </div>
                ...
                <div className="flex flex-col items-center bg-white border border-stone-200 rounded-2xl p-4 w-full md:w-32 text-center shadow-sm">
                  ...
                  <span className="text-xs font-bold text-stone-950">WhatsApp</span>
                  <span className="text-[9px] text-stone-400 mt-1 leading-tight">Pedido listo en tu chat</span>
                </div>
              </div>

              <div className="mt-8 bg-white p-4.5 rounded-2xl text-center border border-stone-200 text-xs">
      ...
      <section className="py-24 bg-[#FAF8F5] relative overflow-hidden border-b border-stone-200/80">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
      ...
      <section id="ferias" className="py-24 bg-white border-b border-stone-200/80 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
            <span className="text-xs font-bold uppercase text-[#8A4F35] tracking-wider bg-[#8A4F35]/5 px-3 py-1 rounded border border-[#8A4F35]/20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            {/* Tarjeta explicativa */}
            <div className="lg:col-span-5 bg-[#FAF8F5] border border-stone-200 rounded-3xl p-6 md:p-8 flex flex-col justify-between shadow-sm">
              <div>
                <div className="p-3 bg-[#8A4F35]/5 text-[#8A4F35] w-fit rounded-xl border border-[#8A4F35]/15 mb-6">
                  <QrCode size={24} />
                </div>
                <h3 className="text-2xl font-playfair font-black text-stone-900 mb-4 tracking-tight">El puesto inteligente</h3>
              ...
              <div className="border-t border-stone-200/80 pt-6 mt-6">
                <h4 className="text-stone-900 font-bold text-xs uppercase tracking-wider mb-4 font-mono">Ventajas en Feria:</h4>
                <ul className="space-y-3.5 text-xs md:text-sm text-stone-600">
            ...
            <div className="lg:col-span-7 bg-[#FAF8F5] border border-stone-200 rounded-3xl p-6 md:p-8 flex flex-col justify-center items-center relative overflow-hidden shadow-sm">
              <div className="w-full max-w-md relative z-10 space-y-6">
                <div className="bg-white p-5 rounded-2xl border border-stone-200 flex items-center justify-between shadow-sm">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-stone-50 rounded-xl border border-stone-200 flex items-center justify-center text-[#8A4F35]">
                      <QrCode size={20} />
                    </div>
                    <div>
                      <h4 className="text-xs font-bold text-stone-900">1. QR en el Stand</h4>
                      <p className="text-[9px] text-stone-400 font-mono">Folleto o cartel de acrílico impreso</p>
                    </div>
                  </div>
                ...
                <div className="bg-white p-5 rounded-2xl border border-stone-200 flex items-center justify-between shadow-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-xs font-bold text-stone-900">2. Catálogo Interactivo</h4>
                      <p className="text-[9px] text-stone-400 font-mono">El cliente recorre tu stock</p>
                    </div>
                  </div>
                ...
                <div className="bg-white p-5 rounded-2xl border border-stone-200 flex items-center justify-between shadow-sm">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-stone-50 rounded-xl border border-stone-200 flex items-center justify-center text-emerald-600">
                      <MessageSquare size={20} />
                    </div>
                    <div>
                      <h4 className="text-xs font-bold text-stone-900">3. Consulta a WhatsApp</h4>
                      <p className="text-[9px] text-stone-400 font-mono">Pedido listo en tu chat</p>
                    </div>
                  </div>
      ...
      <section id="beneficios" className="py-24 bg-[#FAF8F5] border-b border-stone-200/80 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              return (
                <div key={i} className="bg-white p-6 rounded-2xl border border-stone-200 hover:border-stone-300 transition-colors shadow-sm">
                  <div className="p-2.5 bg-[#8A4F35]/5 text-[#8A4F35] w-fit rounded-xl border border-[#8A4F35]/15 mb-4 shadow-inner">
                    <Icon size={20} />
                  </div>
                  <h4 className="text-stone-900 font-bold text-sm md:text-base mb-2 font-playfair">{benefit.title}</h4>
                  <p className="text-stone-500 text-xs md:text-sm leading-relaxed">{benefit.text}</p>
                </div>
              );
            })}
          </div>
      ...
      {/* 8. CÓMO FUNCIONA */}
      <section id="funcionamiento" className="py-24 bg-white border-b border-stone-200/80 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
          ...
          <div className="relative border-l border-stone-200 max-w-3xl mx-auto pl-6 md:pl-8 space-y-12">
            {[
              ...
              <div key={i} className="relative">
                <div className="absolute -left-[31px] md:-left-[39px] top-1.5 w-3.5 h-3.5 rounded-full bg-[#8A4F35] border-4 border-white shadow-md"></div>
                <div>
                  <span className="text-xs font-bold text-[#8A4F35] tracking-wider uppercase font-mono">{item.step}</span>
                  <h3 className="text-lg md:text-xl font-bold text-stone-900 mt-1 mb-2 font-playfair">{item.title}</h3>
                  <p className="text-stone-500 text-xs md:text-sm leading-relaxed">{item.text}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* 9. PLANES Y PRECIOS */}
      <section id="precios" className="py-24 bg-[#FAF8F5] border-b border-stone-200/80 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
      ...
      <section id="contacto" className="py-24 bg-white border-b border-stone-200/80 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
            ...
            <div className="lg:col-span-5 flex flex-col justify-between py-2">
              ...
              <div className="border-t border-stone-200 pt-6 mt-6 space-y-4">
                <h4 className="text-stone-900 font-bold text-xs uppercase tracking-wider text-stone-400 font-mono">Contacto Directo:</h4>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a href={`https://wa.me/${OWNER_CONFIG.OWNER_WHATSAPP}`} target="_blank" className="text-sm font-bold text-stone-800 hover:underline">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${OWNER_CONFIG.EMAIL}`} className="text-sm font-bold text-stone-800 hover:underline">
                      {OWNER_CONFIG.EMAIL}
                    </a>
                  </div>
                </div>
      ...
      <footer className="bg-stone-900 text-stone-400 py-16 px-6 border-t border-stone-950 text-center md:text-left">
